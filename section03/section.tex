...
Like any other architectural style, REST also does have its own 6 guiding constraints, which must be satisfied if an interface needs to be referred to RESTful. These principles are listed below:
\begin{enumerate}
