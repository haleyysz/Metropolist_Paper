...
We split all polygons (except water, park, and castle) into blocks, those under to obtain the preliminary version of the city map. Figure \ref{fig:blocks} is an example of this technique.
